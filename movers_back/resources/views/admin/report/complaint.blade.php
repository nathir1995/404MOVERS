        ...
        <div class="col-lg-4">
            <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item"><a href="#!">Complaint List</a>
                    </li>
                </ul>
            </div>
        </div>
                        ...
                        <table id="alt-pg-dt" class="table table-striped table-bordered nowrap">
                            ...
                            @forelse ($data as $item)
                                <tr class="row_{{$item->id}}">
                                    ...
                                    <td>{{ $item->getComplaintUser->first_name}}</td>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.complaint.view',[$item->id])}}" class="icon-btn btn-primary "><i class="fa fa-eye"></i></a>   
                                        <a href="javascript:void(0);" class="icon-btn btn-info reply_user" attr-id="{{$item->id}}"  data-toggle="modal" data-target="#reply_emquiry"><i class="fa fa-reply"></i></a>
                                        <a href="javascript:void(0);" class="icon-btn btn-danger delete_user" attr-id="{{$item->id}}" data-toggle="modal" data-target="#delete"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>    
                            @empty
                                <tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="sure_reply" class="btn btn-success" data-dismiss="modal" attr_reply_id="">Send</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    $(document).on('click','.delete_user',function(){
        ...
        var url = '{{route('admin.delete.complaint')}}';
