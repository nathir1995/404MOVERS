        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-block">
                    <form action="{{ route('admin.submit.offer')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Title <span class="mandatoryicon">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="title" value="{{ old('title')}}" placeholder="Enter Offer Title" />
                                @error('title')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="description" value="{{ old('description')}}" placeholder="Enter Offer Description" />
                                @error('description')
                                <span class="error_message">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="profile_image">
                                    <img src="" class="img-radius profile_image" alt="Offer-Image" >
                                </div>
                                @error('image')
                                    <span class="error_message">{{$message}}</span>
                                @enderror
